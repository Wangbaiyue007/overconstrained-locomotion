...
extern void rotX(matTypeDef *Mat, double a);
extern void rotZ(matTypeDef *Mat, double a);
extern void tslX(matTypeDef *Mat, double a);
extern void skew(matTypeDef *S, matTypeDef *input);
